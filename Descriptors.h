...
#define _DESCRIPTORS_H_
    ...
    /* Macros: */
        /** Endpoint address of the Mass Storage device-to-host data
         * IN endpoint. */
        #define MASS_STORAGE_IN_EPADDR         (ENDPOINT_DIR_IN  | 3)

        /** Endpoint address of the Mass Storage host-to-device data
         * OUT endpoint. */
    ...
    /* Type Defines: */
         ...
         * with it, which can be used to refer to the interface from
         * other descriptors.
         */
        enum InterfaceDescriptors_t
        {
            /**< Mass storage interface descriptor ID */
            INTERFACE_ID_MassStorage = 0,
        };

        /** Enum for the device string descriptor IDs within the device.
         * Each string descriptor should have a unique ID index associated
         * with it, which can be used to refer to the string from
         * other descriptors.
         */
        enum StringDescriptors_t
        {
            STRING_ID_Language     = 0, /**< Supported Languages
                                        string descriptor ID (must be zero) */
